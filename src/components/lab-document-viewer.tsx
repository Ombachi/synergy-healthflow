    ...
    queryFn: async (): Promise<LabDoc[]> => {
      ...
      return rArr.map((r) => {
        ...
        return {
          ...
          status: r.verified_at ? "verified" : "reported",
          ordered_by: o?.ordered_by ?? null,
          ordering_clinician: o?.ordered_by ? um.get(o.ordered_by) ?? null : null,
          scientist_id: r.verified_by,
          scientist_name: r.verified_by ? um.get(r.verified_by) ?? null : null,
          specimen: t?.specimen ?? s?.specimen_type ?? null,
